...
//CandidateUITabBarController * candidateTab = [[CandidateUITabBarController alloc] initWithNibName:nil bundle:nil];
//[self presentViewController:candidateTab animated:YES completion:nil];
...
//    CandidateUITabBarController * candidateTab = [[CandidateUITabBarController alloc] initWithNibName:nil bundle:nil];
//    [self presentViewController:candidateTab animated:YES completion:NULL];
